...
if (isset($_POST['submit'])) {
    ...
    // Check if checkboxes are set and assign accordingly
    $leadership     = isset($_POST["leadership"]) ? $_POST["leadership"] : 'no';
    $communication  = isset($_POST["communication"]) ? $_POST["communication"] : 'no';
    $management     = isset($_POST["management"]) ? $_POST["management"] : 'no';
    $attitude       = isset($_POST["attitude"]) ? $_POST["attitude"] : 'no';
    $teamWork       = isset($_POST["teamWork"]) ? $_POST["teamWork"] : 'no';
    $adaptability   = isset($_POST["adaptability"]) ? $_POST["adaptability"] : 'no';
    $empathy        = isset($_POST["empathy"]) ? $_POST["empathy"] : 'no';
    ...
    if ($result) {
        ...
        $_SESSION['error'] = "Error: Unable to insert data.";
    }
    $conn->close();
}
?>
