...
<head>
    ...
    <link rel="stylesheet" href="OrganizationStyle.css"/>
    ...
    <!--logo row end-->
     ...
     <nav>
        <div class="container">
            <ul class="nav-links">
                <li>
                    <a href="http://localhost/GroupProject/index.html">HOME</a>
                </li>
...
<div class="image">
    <!--form start-->
<div id="form">
            <h1>Profile for Organizations</h1><br>
            <form name="form" action="" method="POST">
                ...
                <select name="type" id="type" >
                                    <option value="committee">Committee Organization </option>
                                    <option value="non">Non-profit organization </option>
                                    <option value="initial">Initial Organization </option>
                </select><br><br>
                ...
                <label>If you choose other please specify your organizations' interests</label><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `OrganizationProfile` (`name`, `type`, `email`, `city`, `phoneNo`, `interest`, `otherInterests`) VALUES (?, ?, ?, ?, ?, ?, ?)";

    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param("sssssss", $name, $type, $email, $city, $phoneNo, $interest, $otherInterests);
        if ($stmt->execute()) {
